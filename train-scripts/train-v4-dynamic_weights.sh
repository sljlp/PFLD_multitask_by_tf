...
lr=1.25e-5
model_dir=./output_dir/model-v4_dyw_2
...
tflog_dir=./output_dir/tflog-v4_dyw_2
logs=./output_dir/train-v4_dyw_2.log
tfport=8091
loss_type=2 #0 or 2
...
nohup \
python3 -u train_model_v4_dynamic_weights.py --learning_rate=${lr} \
                               --level L5 \
                               --image_size 112 \
                               --max_epoch 1600 \
                               ...
                               --train_file /lp/dataset-10.23/right-jd.csv \
